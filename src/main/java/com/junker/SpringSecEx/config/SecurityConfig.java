...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception { // This method configures security for HTTP requests
        ...
        http.csrf(customizer -> customizer.disable()) // Disables CSRF protection (often used in stateless APIs where CSRF is unnecessary)
        ...
        return http.build(); // The `build()` method compiles all the configurations and returns the `SecurityFilterChain` object
